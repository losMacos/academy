...
Marketplaces uses the JSON standard to display info for our NFTs, and that means we
...
Make note or save the link to the IPFS folder with your json files (the full link,
that links to the folder with all the files), for we will use it in our next step.
